...
- Includes interactive visual elements using Leaflet and Esri World Imagery
- Developed collaboratively with program staff and student contributors
...
A collection of C programming assignments focused on systems-level concepts, debugging, memory management, file formats, testing, and program reliability.

| Assignment | Focus | Repository |
|---|---|---|
| Homework 1 | PNG file processing | [cse320-homework-1](https://github.com/aidancheiban/cse320-homework-1) |
| Homework 2 | PNG and ZLIB processing | [cse320-homework-2](https://github.com/aidancheiban/cse320-homework-2) |
| Homework 3 | Heap and dynamic-memory management | [cse320-homework-3](https://github.com/aidancheiban/cse320-homework-3) |
| Homework 4 | Fuzzing and program testing | [cse320-homework-4](https://github.com/aidancheiban/cse320-homework-4) |
| Homework 5 | Snake game implementation | [cse320-homework-5](https://github.com/aidancheiban/cse320-homework-5) |

**Tech:** C, Makefiles, Linux, debugging, dynamic memory, testing
